                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="img m-center"
                                                            ...
                                                            <img src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_logo.png"
                                                                 width="150" height="37" border="0" alt=""/></td>
                                                    </tr>
                                                </table>
                                            </th>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="text-header"
                                                            style="color:#999999; font-family:'Lato', Arial ,sans-serif; font-size:14px; line-height:18px; text-align:right;"></td>
                                                    </tr>
                                                </table>
                                            </th>
                                        </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="fluid-img"
                                                ...
                                                <img src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_image1.jpg"
                                                     width="650" height="366" border="0" alt=""/></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <td class="img" width="55"
                                                            style="font-size:0pt; line-height:0pt; text-align:left;"><a
                                                                    href="#" target="_blank"><img
                                                                        src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_ico_facebook.jpg"
                                                                        width="34" height="34" border="0" alt=""/></a>
                                                        </td>
                                                        <td class="img" width="55"
                                                            style="font-size:0pt; line-height:0pt; text-align:left;"><a
                                                                    href="#" target="_blank"><img
                                                                        src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_ico_twitter.jpg"
                                                                        width="34" height="34" border="0" alt=""/></a>
                                                        </td>
                                                        <td class="img" width="55"
                                                            style="font-size:0pt; line-height:0pt; text-align:left;"><a
                                                                    href="#" target="_blank"><img
                                                                        src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_ico_instagram.jpg"
                                                                        width="34" height="34" border="0" alt=""/></a>
                                                        </td>
                                                        <td class="img" width="34"
                                                            style="font-size:0pt; line-height:0pt; text-align:left;"><a
                                                                    href="#" target="_blank"><img
                                                                        src="https://coffee-static-1251035454.cos.ap-shanghai.myqcloud.com/productman/mail/images/t7_ico_linkedin.jpg"
                                                                        width="34" height="34" border="0" alt=""/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td class="text-footer2"
                                                ...
                                                <a href="#" target="_blank" class="link-grey-u"
                                                   style="color:#999999; text-decoration:underline;"><span
                                                            class="link-grey-u"
                                                            style="color:#999999; text-decoration:underline;">Unsubscribe</span></a>
